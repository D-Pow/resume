...
\ul{
    ...
    \ul {
        ...
        \item \textbf{Unified state and file structure}, aggregating common needs across many teams into a single source of truth.
    ...
    \item \textbf{Converted entire site from Flow to TypeScript}, consisting of millions of lines of code through homebrewed AST parser CLI util.

    \item \textbf{Mediated org's lack of QA} by building a custom system for running the prod environment locally but with your own code via Docker, allowing sensitive logic to be verified before CD deployment without relying on end-users to test it in prod first.
...
\ressubsection{Picture Place}{React Native, Ionic, PWA, Spring Boot}{June 2022 -- Present}

\ul{
    \item Mobile app to automatically scan images taken of restaurants and/or menus and classify it with AI to add tags (cuisine, price, atmosphere, quality, etc.), adding them to an in-app menu of places you want to visit.
...
\noindent Languages
\par
JavaScript, \ Java, \ HTML, \ SCSS, \ Python, \ SQL, \ PHP, \ LaTeX.
