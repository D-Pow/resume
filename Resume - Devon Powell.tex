...
\ressubsection{Atolls - Senior Full-Stack Software Engineer}{NestJS, Next.js, GraphQL, Docker, AWS}{Jan 2026 -- Present}

\ul{
    \item Create and improve systems for awarding cashback, coupons, and bonuses to smart shopping customers.
}
...
\ressubsection{Home Depot - Senior Full-Stack Software Engineer}{Spring Boot, React, PostgreSQL, GCP}{Oct 2023 -- Dec 2025}
...
\ul{
    ...
    \ul {
        ...
        \item \textbf{Accelerated dev productivity by 20\%} via Bash/Postman scripts and internal sites for token generation, health monitoring, etc.
    ...
    \item Created new \q{HD Pass} loyalty system for point-of-sale and self-checkout to auto-apply coupons, store credit, and saved payment.
    \ul {
...
\ul{
    ...
    \ul {
        ...
        \item Split shared component library to separate repo, published to AWS private registry, installed as a dependency in parents, and added local dev utils for auto-auth renewals.
    }
...
\ul{
    ...
    \ul{
        ...
        \item Included in company-wide React/SCSS design language library and new app boilerplate due to its efficiency.
    }
...
\ressubsection{Picture Place}{React Native, Ionic, PWA, TypeScript}{June 2022 -- Feb. 2025}
...
\ressubsection[https://github.com/D-Pow/anime-atsume]{Anime Atsume}{React/TypeScript, Spring Boot/Java}{June 2020 -- July 2022}
