...
\ressubsection{Home Depot - Senior Software Engineer}{Spring, React, PostgreSQL, GCP, Kubernetes}{Oct 2023 -- Present}
...
\ul{
    ...
    \ul {
        ...
        \item Enhanced Java POS business logic, customer-lookup and payment (Spring Boot) endpoint logic, React/Redux/WebSocket communication, Kubernetes/Google Cloud deployments and pipelines, Prometheus/Grafana/PostHog/Mixpanel analytics, and Cypress end-to-end tests.
    }
...
\noindent Technology
\par
React, \ Spring Boot, \ Git, \ PostgreSQL, \ Redux Toolkit, \ Next.js, \ MobX, \ Webpack, \ Jest, \ Gradle, \ Maven, \ Linux, \ Bash, \ Regex,
\par
Docker, \ Agile (Scrum), \ GitHub, \ BitBucket, \ Jira, \ CI/CD (GH Actions, CircleCI, Jenkins), \ AWS, \ GCP, \ Automation Testing.
